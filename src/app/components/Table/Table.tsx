...
const Table = ({ query }: { query: string }) => {
  ...
  useEffect(() => {
    const fetchdata = async () => {
      try {
        let data;
        if (query) {
          const searchRes = await fetch(`/api/properties?query=${query}`);
  ...
  return (
    <div className="mt-10 p-5 flex justify-between  bg-gray-100">
            ...
            <div>
              <label className="inline-flex items-center mt-3">
                <input
                  ...
                  checked
                />
                <span className="ml-2 text-sm text-gray-700">For Sell</span>
              </label>
            </div>
          </div>
          ...
          <div className="my-4 flex flex-col">
            ...
            <label className="inline-flex items-center mt-3">
              <input
                ...
                checked
              />
              <span className="ml-2 text-sm text-gray-700">1-2</span>
            </label>
            <label className="inline-flex items-center mt-3">
              <input
                type="checkbox"
                ...
                checked
              />
              <span className="ml-2 text-sm text-gray-700">3-4</span>
            </label>
          </div>
          ...
          <div className="my-4 flex flex-col">
            ...
            <label className="inline-flex items-center mt-3">
              <input
                ...
                checked
              />
              <span className="ml-2 text-sm text-gray-700">0 - $ 499</span>
            </label>
            <label className="inline-flex items-center mt-3">
              <input
                type="checkbox"
                ...
                checked
              />
              <span className="ml-2 text-sm text-gray-700">$ 500 - $ 1499</span>
            </label>
          </div>
          ...
          <tbody>
            {properties.map((property: any) => (
              ...
              >
                ...
                <td className="py-4 px-6">{property.placeId}</td>
              </tr>
            ))}
          </tbody>
        </table>
